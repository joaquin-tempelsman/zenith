...
if curl -f http://localhost:8000/health > /dev/null 2>&1; then
    ...
    docker compose -f infrastructure/docker-compose.prod.yml logs api
    exit 1
fi
...
echo "  Stop services:  docker compose -f infrastructure/docker-compose.prod.yml down"
echo "  Restart:        docker compose -f infrastructure/docker-compose.prod.yml restart"
echo ""
